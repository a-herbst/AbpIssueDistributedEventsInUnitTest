...
namespace AbpIssueDistributedEventsInUnitTest.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpIssueDistributedEventsInUnitTest") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpIssueDistributedEventsInUnitTest", DisplayName = "AbpIssueDistributedEventsInUnitTest API", Resources = { "AbpIssueDistributedEventsInUnitTest" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        var commonScopes = new List<string> {
            ...
            "AbpIssueDistributedEventsInUnitTest"
        };
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AbpIssueDistributedEventsInUnitTest_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AbpIssueDistributedEventsInUnitTest_Swagger:RootUrl"]?.TrimEnd('/');
