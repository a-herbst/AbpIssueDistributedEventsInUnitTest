...
public static class AbpIssueDistributedEventsInUnitTestEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpIssueDistributedEventsInUnitTestModuleExtensionConfigurator CLASS (in the Domain.Shared project)
