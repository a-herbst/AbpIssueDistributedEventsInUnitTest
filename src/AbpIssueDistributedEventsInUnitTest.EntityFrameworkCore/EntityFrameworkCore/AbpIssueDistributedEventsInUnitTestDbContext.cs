...
public class AbpIssueDistributedEventsInUnitTestDbContext :
    AbpDbContext<AbpIssueDistributedEventsInUnitTestDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AbpIssueDistributedEventsInUnitTestConsts.DbTablePrefix + "YourEntities", AbpIssueDistributedEventsInUnitTestConsts.DbSchema);
